...
class application(Frame):
    def __init__(self, master):
        ...
        self.canvas = Canvas(self, width=300, height=250, bg='black')
    ...
    def clearCanvas(self):
        ...
        answer.configure(text='Predicted Digit', font=self.fontStyle)
        self.canvas.bind('<B1-Motion>', self.activate_paint)
    ...
    def predictDigit(self):
        ...
        # import the model
        model = load_model('C:/Users/RUTUJA/Downloads/model/model')
...
if __name__ == '__main__':
    ...
    answer = Label(root, text="Predicted Digit: ", font=app.fontStyle)
    answer.pack()
